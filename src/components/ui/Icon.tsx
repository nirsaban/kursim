...
const STROKE_PATHS: Record<string, string[]> = {
  ...
  palette: [
    'M12 2.5a9.5 9.5 0 1 0 0 19c1.5 0 2.2-.9 2.2-1.9 0-.9-.6-1.5-.6-2.3 0-1.1.9-2 2-2h2.2a3.7 3.7 0 0 0 3.7-3.7C21.5 6.3 17.2 2.5 12 2.5z',
    'M7.5 10.5h.01',
    'M11 6.5h.01',
    'M15.5 7.5h.01',
  ],
  ...
  // Social brand glyphs — simplified single-weight strokes to match the set.
  whatsapp: [
    'M12 3.5a8.5 8.5 0 0 1 0 17c-1.6 0-3.1-.44-4.4-1.2L3.5 20.5l1.2-4.1A8.5 8.5 0 0 1 12 3.5z',
    'M9.3 8.7c-.4 2.7 3.3 6.4 6 6l.4-1.8-2.2-.9-.9.9c-.9-.45-2.1-1.6-2.5-2.5l.9-.9-.9-2.2z',
  ],
  instagram: [
  ...
  facebook: ['M13.5 21v-7h3l.5-3.5h-3.5V8.25c0-1 .5-1.75 2-1.75h1.75V3.25S15.8 3 14.75 3c-2.6 0-4.25 1.55-4.25 4.5v3H7.25V14h3.25v7'],
  tiktok: [
    'M14.5 4v10.75a3.75 3.75 0 1 1-3.75-3.75',
    'M14.5 5.5c.6 2.4 2.2 4 4.75 4.25',
  ],
  youtube: ['M3.5 8.5A3 3 0 0 1 6.5 5.5h11a3 3 0 0 1 3 3v7a3 3 0 0 1-3 3h-11a3 3 0 0 1-3-3v-7z'],
  linkedin: [
    'M6.5 10v7.5',
    'M6.5 6.4h.01',
    'M11 17.5V10',
    'M11 13.2c0-1.8 1.3-3.2 3.1-3.2s3.1 1.4 3.1 3.2v4.3',
  ],
  globe: [
    'M12 3a9 9 0 1 1 0 18 9 9 0 0 1 0-18z',
    'M3.5 12h17',
    'M12 3c2.4 2.6 2.4 15.4 0 18',
    'M12 3c-2.4 2.6-2.4 15.4 0 18',
  ],
};
...
const FILL_PATHS: Record<string, string[]> = {
  ...
  youtube: ['M10.5 9.25 15 12l-4.5 2.75z'],
